...
- [ ] **Phase 4. 좋아요 수 구조 개선** — 비정규화 검증 + 좋아요 등록/취소 ↔ like_count 동기화
- [ ] **Phase 5. Redis 캐시** — 상세/목록 캐시, TTL·키 설계·무효화, 캐시 미스 안전성
...
### ❤️ Structure
- [ ] 목록/상세에서 좋아요 수 조회 및 좋아요 순 정렬 가능하도록 구조 개선 → Phase 4
- [ ] 좋아요 적용/해제 시 like_count 동기화 → Phase 4

### ⚡ Cache
- [ ] Redis 캐시 적용 + TTL 또는 무효화 전략 → Phase 5
- [ ] 캐시 미스 상황에서도 정상 동작 → Phase 5
